 ...
 *
 *Class DataPacket
 *Purpose: This class extends the Packet class and represents a Data Packet type.
 *Data Members:
 *      There is no data member for this class.
 *Methods:
 *      DataPacket() - Default constructor.
 *      processFoundPacket() - Produces a correct message. In case the packet is a Data Packet, a sending packet message
 *                             is produced.
