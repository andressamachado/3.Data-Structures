 ...
 *Class Packet
 *Purpose:
 *         This class represents the packets and are extended by the DataPacket class and the RoutingPacket class.
 ...
 *          calcHash()              - returns the calculation made in the calcHash() method from IPAddress class
***************************************************************************************/
public class Packet {
